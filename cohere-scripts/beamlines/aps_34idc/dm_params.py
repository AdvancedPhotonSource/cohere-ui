class DM_params():
    ...
    def get_corrections(working_dir, **kwargs):
        ...
        :return:
        """
        return (working_dir + '/cohere-scripts/beamlines/asp_34idc/detector_corrections/34icdTIM2/current_darkfield.tif',
        working_dir + '/cohere-scripts/beamlines/asp_34idc/detector_corrections/34icdTIM2/current_whitefield.tif')
